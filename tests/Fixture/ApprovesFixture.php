 ...
 *
 */
class ApprovesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'approved_day' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'foreign_key' => 1,
            'status' => 1,
            'created' => '2017-10-12 07:18:41',
            'modified' => '2017-10-12 07:18:41',
            'approved_day' => '2017-10-12'
        ],
    ];
}
